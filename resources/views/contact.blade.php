...
<section class="bgwhite p-t-66 p-b-60">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 p-b-30">
                <form class="leave-comment" action="{{action('MessageController@addPost')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="nom" placeholder="Nom et prénom">
                    </div>

                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="tel" placeholder="Numéro de téléphone">
                    </div>
                    ...
                    <textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="texte" placeholder="Message"></textarea>
