...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::asset('images/logo12.png')}}">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="tables-data.html" class="dropdown-toggle"> <i class="menu-icon fa fa-laptop"></i>Clients</a>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="tables-data.html" class="dropdown-toggle" > <i class="menu-icon fa fa-table"></i>Commandes</a>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="prod.html">Ajouter produit</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="modifierprod.html">Modifier produits</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="modifierprod.html">Supprimer produits</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
