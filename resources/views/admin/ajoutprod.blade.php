...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{ action('ProduitController@addPost') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="number" id="points" name="points" class="form-control">
                        <small class="help-block form-text">Score attribué lors de l'achat du produit</small>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="test-input" class=" form-control-label">Catégorie</label>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col col-md-3"><label for="test-input" class=" form-control-label">Sous catégorie</label>
                    </div>
                    <div class="col-12 col-md-9">
                ...
                <div class="row form-group">
                    <div class="col col-md-3"><label for="file-input" class=" form-control-label">télécharger la photo
                            du produit</label></div>
