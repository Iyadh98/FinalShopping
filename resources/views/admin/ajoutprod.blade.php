                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Score</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="nombre" name="nombre" placeholder="Attribuer un score" class="form-control"><small class="help-block form-text">Score attribué lors de l'achat du produit</small></div>
                            </div>
                            <div class="row form-group">
